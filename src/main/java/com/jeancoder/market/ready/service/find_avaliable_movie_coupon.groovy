...
//
//class find_avaliable_movie_coupon {
//	
//	private static final JCLogger LOGGER = LoggerSource.getLogger(find_avaliable_movie_coupon.class);
...
//	
//	public List<CouponCode> getCouponCodes (String mobile,String sid,def movie){
//		List<CouponCode> ccList = cs.get_codes_by_mobile(mobile);
//		cs.is_Available_movies(ccList, sid, movie);
//	}
//}
