...
//	p = '{"card_code":"51,52,53","g":[[8467,"100",null,1000.00,5.00],[8467,"100",null,2000.00,5.00]]}'
//	sid = '3'
//	pid = '1'
	...
	for (CouponCode couponCode : couponCodeList) {
		...
		if (!CouponConstants._coupon_app_general_.equals(cb.crapp)) {
			mcc.code = JsConstants.unknown;
			mcc.msg = "卡劵类型使用错误"
			return mcc;
		}
	...
	def util = CouponFactoryUtil.getCouponUtil(CouponConstants._coupon_app_general_);
